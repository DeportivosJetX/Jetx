    ...
    <?php if(Route::has('login')): ?>
        <div class="absolute top-0 right-0 mt-4 mr-4 space-x-4 sm:mt-6 sm:mr-6 sm:space-x-6">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(url('/dashboard')); ?>" class="no-underline hover:underline text-sm font-normal text-teal-800 uppercase"><?php echo e(__('Dashboard')); ?></a>
            <?php else: ?>
...
<?php /**PATH C:\www\jetx\resources\views/welcome.blade.php ENDPATH**/ ?>